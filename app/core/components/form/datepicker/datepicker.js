angular.module('GO.core.form')
		...
		.directive('datepicker', function () {
			return {
				restrict: 'EA',
				replace: true,
				templateUrl: 'core/components/form/datepicker/datepicker.html',
				scope: {
					datepickerMode: '=?',
					dateDisabled: '&'
				},
		...
		.directive('daypicker', ['dateFilter', function (dateFilter) {
				return {
					restrict: 'EA',
					replace: true,
					templateUrl: 'core/components/form/datepicker/day.html',
					require: '^datepicker',
		...
		.directive('monthpicker', ['dateFilter', function (dateFilter) {
				return {
					restrict: 'EA',
					replace: true,
					templateUrl: 'core/components/form/datepicker/month.html',
					require: '^datepicker',
					link: function (scope, element, attrs, ctrl) {
						ctrl.step = {years: 1};
						ctrl.element = element;
		...
		.directive('yearpicker', ['dateFilter', function (dateFilter) {
				return {
					restrict: 'EA',
					replace: true,
					templateUrl: 'core/components/form/datepicker/year.html',
					require: '^datepicker',
					link: function (scope, element, attrs, ctrl) {
					...
					link: function (scope, element, attrs, ngModel) {
						...
						function parseDate(viewValue) {
							if (!viewValue) {
								...
								var date = GoDateParser.parse(viewValue, dateFormat) || new Date(viewValue);
								if (isNaN(date)) {
...
//								element.triggerHandler('focus', [true]);
							}
						};
...
//							} else if (evt.which === 40 && !scope.isOpen) {
							...
							if(evt.which===16 || evt.which===17){
								//shift or ctrl
								return;
							}

							if (evt.which === 40) { //Arrow down
								scope.isOpen = true;
								$timeout(function(){
									scope.$broadcast('datepicker.focus');
								});
							}else if((evt.which !== 9 || evt.shiftKey) && scope.isOpen) //Tab pressed go into date picker
							{
...
//							element.triggerHandler('focus', [true]);
		...
		.directive('datepickerPopupWrap', function () {
			return {
				...
				replace: true,
				transclude: true,
				templateUrl: 'core/components/form/datepicker/popup.html',
